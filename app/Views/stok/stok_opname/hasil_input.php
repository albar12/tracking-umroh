        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mt-4">
                        <div class="col-sm-12">
                            <a href="<?= base_url('stok/stok-opname/input-stok-opname/' . $so_id) ?>" class="btn btn-secondary waves-effect">Input Kekurangan</a>
                            <button class="btn btn-primary" type="submit" style="float: right" id="syncron_stok_opname">Syncron</button>
                        </div>
                    </div>
                </div>
            </div>

                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="no_dokument" disabled placeholder="No Dokumen" value="<?= $barangMasuk['no_dokument'] ?>">
                                <input type="hidden" id="no_dokument" value="<?= $barangMasuk['no_dokument'] ?>">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <select class="form-control select select2" name="persetujuan" id="persetujuan" required>
                                    ...
                                    <option value="Approve" <?= $barangMasuk['status_approval'] == 'Approve' ? 'selected' : '' ?>>Approve</option>
                                    <option value="UnApprove" <?= $barangMasuk['status_approval'] == 'UnApprove' ? 'selected' : '' ?>>UnApprove</option>
                                </select>
                                <div class="invalid-feedback">
                                    Data wajib diisi.
                                </div>
                        ...
                        <div class="col-md-3 d-none" id="approval_keteragan">
                            <div class="mb-3">
                                ...
                                <textarea name="keterangan" id="keterangan_approval" class="form-control" rows="2"><?= $barangMasuk['approval_keterangan'] ?></textarea>
                                <div class="invalid-feedback">
                                    Data wajib diisi.
                                </div>
                            </div>

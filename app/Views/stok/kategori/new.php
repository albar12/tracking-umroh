        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form class="needs-validation" action="<?= base_url('stok/kategori') ?>" method="POST" enctype="multipart/form-data" novalidate>
                        <?= csrf_field(); ?>
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-12">
                                    ...
                                    <input type="text" class="form-control number-only" id="kategori" name="kategori" autofocus required placeholder="Kategori">

    ...
    <div class="row align-items-center mb-4">
        <div class="col-sm-6">
            <h4 class="mb-1 fw-bold text-dark fs-4">
                <i class="fa-solid fa-bed text-success me-2"></i> Data Detail <?= $title ?>
            </h4>
        </div>
                ...
                <div class="card-body p-4 p-lg-5">
                    ...
                    <div class="row g-3">
                        <div class="row g-3">
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label for="kamar" class="form-label fw-semibold text-secondary fs-7">Jenis Kamar</label>
                                    <input type="text" class="form-control number-only py-2 rounded-3" id="kamar" name="kamar" minlength="6"
                                        autofocus disabled placeholder="Jenis Kamar" value="<?= $jenisKamar['kamar'] ?>">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-switch pt-1">
                                        <input class="form-check-input" disabled type="checkbox" role="switch" id="status" name="status" value="Aktif" style="width: 2.8em; height: 1.4em; cursor: pointer;" <?= (isset($jenisKamar['status']) && $jenisKamar['status'] === 'Aktif') ? 'checked' : '' ?>>

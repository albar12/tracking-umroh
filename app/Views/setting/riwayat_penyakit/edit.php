    ...
    <div class="row align-items-center mb-4">
        <div class="col-sm-6">
            <h4 class="mb-1 fw-bold text-dark fs-4">
                <i class="fa-solid fa-stethoscope text-success me-2"></i> Form Edit <?= $title ?>
            </h4>
            <p class="text-muted mb-0 fs-7">Lengkapi data riwayat penyakit khusus di bawah ini dengan benar.</p>
        </div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                <div class="card-body p-4 p-lg-5">
                    ...
                    <form class="needs-validation" action="<?= base_url('setting/riwayat-penyakit/' . $id) ?>" method="POST" enctype="multipart/form-data" novalidate>
                        <?= csrf_field(); ?>
                        ...
                        <div class="row g-3">
                            <div class="row g-3">
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label for="riwayat_penyakit_khusus" class="form-label fw-semibold text-secondary fs-7">Riwayat Penyakit Khusus <code class="text-danger">*</code></label>
                                        <input type="text" class="form-control number-only py-2 rounded-3" id="riwayat_penyakit_khusus" name="riwayat_penyakit_khusus" minlength="6"
                                            autofocus required placeholder="Riwayat Penyakit Khusus" value="<?= $riwayatPenyakit['riwayat_penyakit_khusus'] ?>">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-switch pt-1">
                                            <input class="form-check-input" type="checkbox" role="switch" id="status" name="status" value="Aktif" style="width: 2.8em; height: 1.4em; cursor: pointer;" <?= (isset($riwayatPenyakit['status']) && $riwayatPenyakit['status'] === 'Aktif') ? 'checked' : '' ?>>

    ...
    <div class="row align-items-center mb-4">
        <div class="col-sm-6">
            <h4 class="mb-1 fw-bold text-dark fs-4">
                <i class="fa-solid fa-stethoscope text-success me-2"></i> Form Tambah <?= $title ?>
            </h4>
            <p class="text-muted mb-0 fs-7">Lengkapi data riwayat penyakit di bawah ini dengan benar.</p>
        </div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                <div class="card-body p-4 p-lg-5">
                    ...
                    <form class="needs-validation" action="<?= base_url('setting/riwayat-penyakit') ?>" method="POST" enctype="multipart/form-data" novalidate>
                        <?= csrf_field(); ?>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control number-only py-2 rounded-3" id="riwayat_penyakit_khusus" name="riwayat_penyakit_khusus" minlength="6"
                                        autofocus required placeholder="Riwayat Penyakit Khusus">

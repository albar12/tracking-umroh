$(document).ready(function () {
    var table = $("#datatable").DataTable({
        ...
        ajax: {
            url: "/setting/metode-pembayaran/getMetodes",
            type: "POST",
            data: function (d) {
            },
        },
        columns: [
            ...
            },
            {
                ...
                "render": function (data, type, row) {
                    ...
                    buttons += `<a href="metode-pembayaran/${encodeURIComponent(data)}" class="text-info" title="Lihat Data">
                                            <i class="fa-solid fa-eye font-size-18"></i>
                                        </a>`;
                    buttons += `<a href="metode-pembayaran/${encodeURIComponent(data)}/edit" class="text-success" title="Edit Data">
    ...
    $(document).on("click", ".delete-btn", function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: BASE_URL + 'setting/metode-pembayaran/' + userId,
                    type: "POST",
                    data: {
                        _method: "DELETE",

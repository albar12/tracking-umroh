$(document).ready(function () {
    ...
    var table = $("#datatable").DataTable({
        ...
        ajax: {
            url: "/setting/ukuran-seragam/getUkuranSeragams",
            type: "POST",
            data: function (d) {
                // d.filters = {
        ...
        columns: [
            ...
            },
            {
                ...
                "render": function (data, type, row) {
                    ...
                    buttons += `<a href="ukuran-seragam/${encodeURIComponent(data)}" class="text-info" title="Lihat Data">
                                            <i class="fa-solid fa-eye font-size-18"></i>
                                        </a>`;
                    buttons += `<a href="ukuran-seragam/${encodeURIComponent(data)}/edit" class="text-success" title="Edit Data">
    ...
    $(document).on("click", ".delete-btn", function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: BASE_URL + 'setting/ukuran-seragam/' + userId,
                    type: "POST",
                    data: {
                        _method: "DELETE",
